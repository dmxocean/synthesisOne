...
1. get_translators_for_manufacturer_or_sector - Find translators with experience in a specific manufacturer/sector
2. get_manufacturer_data_for_translator - Find manufacturers/sectors a specific translator has worked with
3. get_quality_for_translator - Get average quality evaluation for a specific translator-language pair
...
class QueryFunctions:
    ...
    def _load_data(self):
        ...
        try:
            ...
            translator_data_path = self.data_dir / Files.TRANSLATOR_DATA_JSON
            with open(translator_data_path, "r", encoding="utf-8") as f:
                self.translator_data = json.load(f)
            
            # Load lookup indexes
            lookup_indexes_path = self.data_dir / Files.LOOKUP_INDEXES_JSON
    ...
    def get_manufacturer_data_for_translator(self, translator, source_lang, target_lang):
        """
